...
public class ListViewWithImages extends Application {
   ...
   private final Image IMAGE_RUBY  = new Image(ListViewWithImages.class.getResource("/icons/info.png").toString(), 64, 64, false, false);
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.show();
        	...
        	String toret= listView.getSelectionModel().getSelectedItem();
